      ...
      <div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border mb-8">
          <div className="flex items-center gap-6">
            <div className="relative w-24 h-24 rounded-full overflow-hidden bg-gray-200 border-2 border-white shadow-md ring-2 ring-gray-200 flex-shrink-0 flex items-center justify-center">
              {/* This SVG creates the default person icon */}
              <svg
